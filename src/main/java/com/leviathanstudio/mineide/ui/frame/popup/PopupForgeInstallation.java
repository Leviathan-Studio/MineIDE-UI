...
public class PopupForgeInstallation
{
    ...
    public static void showPopup()
    {
        ...
        alert.setHeaderText(Translation.LANG.getTranslation("alert.forge.reinstall.header") + Gui.mineIdeInfo.getForgeVersion());
        ...
        ButtonType buttonCancel = new ButtonType(Translation.LANG.getTranslation("button.cancel"), ButtonData.CANCEL_CLOSE);
